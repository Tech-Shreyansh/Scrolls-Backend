...
def send_member_id(email,member_id,check):
    subject = "Successful member registration for SCROLLS'23"
    if check==1:
        text = f'Dear participant,You have successfully registered yourself for SCROLLS23. Given below is your Scrolls ID:Scrolls id = {member_id}Keep the above ID safe and secure as it will be used for the next phase of registration i.e. team registration.Regards,Team SCROLLS'
        style = f'<p>Dear participant,<br>You have successfully registered yourself for SCROLLS23. Given below is your Scrolls ID:<br><strong style="font-size: 18px;">Scrolls id = {member_id}</strong>.</p><p style="font-size: 18px;"> <br><br>Keep the above ID safe and secure as it will be used for the next phase of registration i.e. team registration.<br><br>Regards,<br>Team SCROLLS</p><div style="text-align:center; font-size:40px; color:grey; margin-top:20px;"><strong>SCROLLS</strong></div>'
    else:
